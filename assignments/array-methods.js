...
// Problem 1 
// Event director would like to send a personal thank you note to all large donors.
let lgDonor = [];

lgDonor = runners.filter(runner => runner.donation > '200');
    
console.log(lgDonor);

// Problem 2
//How many runners are students?
