...
// Problem 1
//The event director has decided to give everyone who donated over $200 a special shirt. Make a new list with all the folks who should receive the shirt.
const bigSpenders = runners.filter((runner) => runner.donation > 200);
console.log(bigSpenders);


// Problem 2
//It appears that everyone with a last name of more than 7 letters is going to need a special name tag, make a list of all the people who need the special name tag.
const longName = runners.filter((runner) => runner.last_name.length > 7);
console.log(longName);



// Problem 3
//It appears that it may rain on race day. The event director needs a list of just all the emails so he can send out an email blast to bring jackets. Make the list of emails.
