...
// Problem 1
// ==== Challenge ====
// The event director wants all of the email addresses for the runners to be able to add them to their mailing list for future events. 

let eMail = runners.forEach(currentValue => {
