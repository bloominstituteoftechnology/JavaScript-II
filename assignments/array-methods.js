...
let largeShirts = [];
 largeShirts = runners.filter(function(shirts) {
...
let ticketPriceTotal = [];
    ticketPriceTotal = runners.reduce(function(donations, currentValue) {
...
// Problem 1 - Return a list of all the companies that have participated
let partComp = [];
    partComp = runners.map(function(currentValue) {
        return currentValue.company_name;
    });
    console.log(partComp);
// Problem 2 - Return a list of all the participants emails.
let partEmail = [];
    runners.forEach(function(element) {
        partEmail.push(element.email);
    });
    console.log(partEmail);

// Problem 3 - Check the donations of all participants to find out who donated over a certain amount.
let lgDon = [];
    lgDon = runners.filter(function(donation) {
        return donation.donation >= 250;
    });
    console.log(lgDon);