...
let ticketPriceTotal = runner.reduce((totalPrice, item) => totalPrice + item.donation, 0);
...
// and the 5k fun run theme.  Try to create and then solve 3 unique problems using one or many of the array methods listed above.
