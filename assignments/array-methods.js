...
let ticketPriceTotal = runners.reduce((totalPrice, value) => {
    return totalPrice + value.donation;
}, 0);
...
// Problem 1
// The Director would like to give a special gift to the runners that donated more than 100$. He needs a list of the runners.
let premiumRunners = runners.filter((value) => {
    return value.donation >= 100;
});
