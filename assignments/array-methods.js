...
// Problem 2
// new array with first name, last name, and email to upper case
let someCaps = runners.map( item => [item.first_name.toUpperCase(), item.last_name.toUpperCase(), item.email.toUpperCase()]);
console.log(someCaps);
...
console.log(largeShirtsSmallDonations);