...
let ticketPriceTotal = runners.reduce((theReducer, data) => {
...
// Problem 1 //Want to see who donated less than $50. 
let companyGroups = runners.filter(data => {
    if (data.donation < 50) {
