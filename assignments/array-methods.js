...
//     largeShirts.push(large.shirt_size === "L")
// })    
...
ticketPriceTotal = runners.reduce(function(totalDonation, currentValue){
...
// Problem 1 Find the Highest Donors (>$200)
let highestDonors = []
highestDonors = runners.filter((currentValue) => {
    return currentValue.donation > 200;
})
console.log(highestDonors);


// Problem 2 Get a list of all companies participating

// let allCompanies = []
// allCompanies = runners.forEach(function(currentValue){
//     allCompanies.push(runners.company_name)
// });
// console.log(allCompanies);

let allCompanies = [];
runners.forEach(currentValue => {
    allCompanies.push(currentValue.company_name)
})
console.log(allCompanies);
