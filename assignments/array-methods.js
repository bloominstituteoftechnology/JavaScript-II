// A local community center is holding a fund rasising 5k fun run and has invited 50 small
// businesses to make a small donation on their behalf for some much needed updates to their
...
// The large shirts won't be available for the event due to an ordering issue.  Get a list of
// runners with large sized shirts so they can choose a different size. Return an array named
...
let ticketPriceTotal = runners.reduce((total, runner) => total + runner.donation);
console.log(ticketPriceTotal);

// ==== Challenge 5: Be Creative ====
// Now that you have used .forEach(), .map(), .filter(), and .reduce().  I want you to think
// of potential problems you could solve given the data set and the 5k fun run theme. Try to
