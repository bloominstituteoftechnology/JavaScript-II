...
const allCaps = runners.map(function(runner) {
    console.log(`${runner.first_name.toUpperCase()} `);
  });
...
const reduceTicketPriceTotal = runners.reduce((total, runners) => {
    return total += runners.donation;
},0);

console.log(reduceTicketPriceTotal);

// ==== Challenge 5: Be Creative ====
// Now that you have used .forEach(), .map(), .filter(), and .reduce().  I want you to think of potential problems you could solve given the data set and the 5k fun run theme.  Try to create and then solve 3 unique problems using one or many of the array methods listed above.

// Problem 1 Company wants to send out mass emails thankning averyone for their efforts and participation. Create an array of just emails.
let eMails = [ ];
