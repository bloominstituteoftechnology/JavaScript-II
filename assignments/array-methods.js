...
runners.forEach(function(item) {
    fullName.push(`The first and last name of runner ${item.id}: ${item.first_name} ${item.last_name}`)
});
...
let ticketPriceTotal = runners.reduce((total, money) => total + money.donation, 0)  
