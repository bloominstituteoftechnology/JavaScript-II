...
let thankYou = runners.map(function(element){
    return `Hi ${element.first_name} ${element.last_name}. Thank you for your donation of $${element.donation}! We look forward to seeing you at the race. We will have a ${element.shirt_size} shirt ready for you when you check in.`
})
