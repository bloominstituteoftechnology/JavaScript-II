...
let allCaps = runners.map((element) => {return element.first_name.toUpperCase();})
console.log(allCaps); 
...
let ticketPriceTotal = runners.reduce((accumulator, element) => accumulator+element.donation, 0);
console.log(ticketPriceTotal);

// ==== Challenge 5: Be Creative ====
// Now that you have used .forEach(), .map(), .filter(), and .reduce().  I want you to think of potential problems you could solve given the data set and the 5k fun run theme.  Try to solve 3 unique problems using one or many of the array methods listed above.

// Problem 1: The event director needs a list of companies participating to send everyone a thank you.
let companyName = [];
runners.forEach((element) => companyName.push(element.company_name));
