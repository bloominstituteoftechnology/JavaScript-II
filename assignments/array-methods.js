...
let isLarge = runner => runner.shirt_size === 'L';

let largeShirts = runners.filter(isLarge);

console.log(largeShirts);

// ==== Challenge 4: Use .reduce() ====
// The donations need to be tallied up and reported for tax purposes. Add up all the donations into a ticketPriceTotal and log the result
let ticketPriceTotal = runners.reduce((sum, cur) => sum + cur.donation, 0);
