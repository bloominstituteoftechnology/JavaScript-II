...
console.log(runners[0]["first_name"]);
...
//         console.log(element);    
//         fullNameTemp.push(element['first_name'] + element['last_name'])
//     });
//     return fullNameTemp;
// };
...
let temp = []
runners.forEach(element => {
    temp.push(element['donation']);
});

let ticketPriceTotal = temp.reduce(reducer) 
...
// Problem 1
//You wanna start a clubs of runners who's names all start with K

let kName = runners.filter(element => element['first_name'][0] == 'K');
console.log(kName);

// Problem 2
//Everyone who's name doesn't start with K is super upset and you want to comfort them
let noKRunners = runners.filter(element => element['first_name'][0] != 'K').forEach(element => {
    console.log(`Sorry your name doesn't start with "K", ${element['first_name']}`)
});



// Problem 3
//You're tired of excluding people whose names don't start with K from your club, so you make everyone's name start with K
let newKName = (runners.map(element => element['first_name'] = element['first_name'].toLowerCase()).map(element => element = ['K'] + element ));
console.log(newKName);
