...
let allCaps = [];
// var capitalName = runners.map(function(obj){
// 	var caps = obj.first_name.toUpperCase();
// 	return caps;
// });
const capital = runners.map(function(obj){
...
var total = runners.reduce(function(result, item){
	return result + item.donation;
}, 1);
ticketPriceTotal.push(total);
console.log(`The total donations are $${ticketPriceTotal}.`);
