...
let fullName = [];
let runnerName = runners.forEach((data) => fullName.push(`${data.first_name} ${data.last_name}`));
...
let largeShirts = runners.filter((data) => data.shirt_size === 'L');
console.log(largeShirts);

// ==== Challenge 4: Use .reduce() ====
// The donations need to be tallied up and reported for tax purposes. Add up all the donations into a ticketPriceTotal array and log the result
let ticketPriceTotal = runners.reduce((reducer, data) => reducer += data.donation, 0);
