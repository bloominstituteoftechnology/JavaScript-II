...
let largeShirts = [];
largeShirts = runners.filter(prop => prop.shirt_size === 'L')
...
// Problem 1
// Returns names 8 letters or more long
let longNames = runners.filter(name => name.first_name.length > 7)
