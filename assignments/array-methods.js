...
let fullName = [];
let rFullName = runners.forEach(function(runner){
...
let ticketPrices = [];
let total = runners.forEach(function (runner) {
    ticketPrices.push(runner.donation);
});
let priceTotal = ticketPrices.reduce(function(total, price) {
    return total + price;
}, 0);
