...
// Problem 1
//Make a list of runners from the UK by filtering for .uk email addresses
let britishRunners = runners.filter(person => person.email[person.email.length - 1] === 'k' && person.email[person.email.length - 2] === 'u');
console.log(britishRunners);
