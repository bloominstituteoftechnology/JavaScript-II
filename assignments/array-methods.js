...
let sum = 0
ticketPriceTotal.push(runners.reduce((acc, runner) => {
    return  sum += runner.donation
}))
console.log(ticketPriceTotal);

// ==== Challenge 5: Be Creative ====
// Now that you have used .forEach(), .map(), .filter(), and .reduce().  I want you to think of potential problems you could solve given the data set and the 5k fun run theme.  T
