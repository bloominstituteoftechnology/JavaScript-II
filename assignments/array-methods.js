...
let ticketPriceTotal = runners.reduce(function(sum, runner){
...
// Problem 1
// The venue has shrunk. 
// Wave 1 will be the Runners with ID #01-#25. They can compete.
// Wave 2 will be the Runners with ID #26-#50. They can not compete.
let Wave1 = runners.filter(function(runner){
    return runner.id <= "25"
})
console.log(Wave1);

// Problem 2
// The venue costs extra.
// This is a special venue so only those that have donated 
// more than $200 will be allowed to enter. 
let TopDonors = runners.filter(function(runner){
    return runner.donation >= "200"
})
console.log(TopDonors);

// Problem 3
// A certain Athlete is afraid that his  Ex Wife will be racing!
// Check the list of runners for the names "Jessey"
let ExWife = runners.filter(function(runner){
    return runner.first_name === "Jessey"
})
console.log(ExWife);
