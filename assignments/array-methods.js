...
runners.forEach(runner => { return ticketPriceTotal.push(runner.donation)});
ticketPriceTotal = ticketPriceTotal.reduce((total, donation) => {return total + donation})
console.log(ticketPriceTotal);

// ==== Challenge 5: Be Creative ====
// Now that you have used .forEach(), .map(), .filter(), and .reduce().  I want you to think of potential problems you could solve given the data set and the 5k fun run theme.  Try to solve 3 unique problems using one or many of the array methods listed above.

// Problem 1: In problem 1 we used .forEach() to log each runners full name starting with last name, implement this function again to log each runners name in "LastName, FirstName" formatting, make sure to undo your uppercasing from Challenge 2, the director has been divested of power!
let properName = [];
