...
// businesses to make a small donation on their behalf for some much needed updates to 
//their facilities.  Each business has assigned a representative to attend the event along 
//with a small donation.

// Scroll to the bottom of the list to use some advanced array methods to help the event 
//director gather some information from the businesses.
...
// The event director needs both the first and last names of each runner for their running 
//bibs.  Combine both the first and last names into a new array called fullName. 
...
//because the director BECAME DRUNK WITH POWER. Convert each first name into all caps and 
//log the result
let allCaps = ['FIRST_NAME'];
const map1 = allCaps.map(x => x * 2 );
console.log(allCaps); 
...
//Return an array named largeShirts that contains information about the runners that have 
//a shirt size of L and log the result
var largeShirts = ['3XL', '2XL', 'XL', 'L', 'M', 'S', 'XS'];
const result = largeShirts.filter(word => word.length > 0);
console.log(result);
...
const ticketPriceTotal = [75, 148, 171, 288, 291, 27, 261, 28, 110, 62, 76, 
    91, 9, 204, 252, 147, 172, 266, 148, 292, 102, 213, 137, 96, 128, 234, 
    190, 31, 52, 5, 82, 5, 110, 97, 17, 30, 262, 212, 74, 101, 156, 291, 241, 
    262, 239, 11, 55, 214, 107, 171];
...
//I want you to think of potential problems you could solve given the 
//data set and the 5k fun run theme.  Try to create and then solve 3 unique 
