...
let bigDono = [];
bigDono = runners.filter(runner => runner.donation >= 100);
console.log(bigDono);

// Problem 2 - find all .org email
let nonProfit = [];
nonProfit = runners.filter(runner => runner.email.includes(".org"));
console.log(nonProfit);

// Problem 3 - give all L-sized runners XL shirts instead, follow-up on Challenge 3
let sizeUp = [];
sizeUp = runners.map(runner => runner.shirt_size.replace("L", "XL"));
console.log(sizeUp);
