...
// Problem 1
 ...
 let printingXSmallShirts = runners.filter(function(element) {
    if(element.shirt_size === 'XS') {
        return element.shirt_size;
    }
 });
 let printingSmallShirts = runners.filter(function(element) {
    if(element.shirt_size === 'S') {
        return element.shirt_size;
    }
 });
  let printingMediumShirts = runners.filter(function(element) {
    if(element.shirt_size === 'M') {
        return element.shirt_size;
    }
 });
 let printingLargeShirts = runners.filter(function(element) {
    if(element.shirt_size === 'L') {
        return element.shirt_size;
    }
 });
 let printingXLargeShirts = runners.filter(function(element) {
    if(element.shirt_size === 'XL') {
        return element.shirt_size;
    }
 });
  let printing2XShirts = runners.filter(function(element) {
    if(element.shirt_size === '2XL') {
        return element.shirt_size;
    }
 });
   let printing3XShirts = runners.filter(function(element) {
    if(element.shirt_size === '3XL') {
        return element.shirt_size;
    }
 });
 console.log(`\n \n We need to print these quantity T-Shirts:\n \n XS = ${printingXSmallShirts.length} 
                                                    \n S =  ${printingSmallShirts.length}
                                                    \n M =  ${printingMediumShirts.length}
                                                    \n L =  ${printingLargeShirts.length} 
                                                    \n Xl =  ${printingXLargeShirts.length}
                                                    \n 2XL =  ${printing2XShirts.length}
