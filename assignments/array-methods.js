...
let donationsMatched = runners.map(function(i) {
    return i.donation * 2;
})
console.log(donationsMatched);

// Problem 2
//List of companies who have donated over $200
let topDonors = runners.filter((data, i) => {
