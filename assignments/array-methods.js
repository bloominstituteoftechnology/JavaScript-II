...
runners.filter(function (value) {
    if (value.shirt_size === "L") {
        largeShirts.push(value)
    }
})
...
// Problem 1: "What Breed is Fito" 
//Use .forEach to determine the dog name and dog breed for the volunteer coordinater at Happy Puppy Pound 
