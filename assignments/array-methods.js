...
// ==== Problem 1 ====
// Big boss man needs a list of all the emails of the runners to update them on the final race results.
const runnerEmails = [];
runners.forEach(runner => runnerEmails.push(runner.email));
console.log(runnerEmails);

// ==== Problem 2 ====
// Big boss wants a list of first names and the company that each runner is from.
let runnerComp = [];
...
// ==== Problem 3 ====
// Boss man wants to give extra recognition for any runner who donated over 100.
let bigBallers = [];
