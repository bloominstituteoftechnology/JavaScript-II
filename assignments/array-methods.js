...
let allCaps = [];
runners.map((item) => {
    allCaps.push(item.first_name.toUpperCase() + " " + item.last_name.toUpperCase())
})
console.log(allCaps); 
...
runners.filter(pullLargeShirts);
