...
// Neither of these will work in my Console but I know they are right.
...
wishfulThinking = runners.map(runner => {
    return runner.donation * 1000;
});
