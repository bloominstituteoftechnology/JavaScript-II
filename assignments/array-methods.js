...
runners.forEach( function(currentValue) { 
    fullName.push(currentValue.first_name); 
    fullName.push(currentValue.last_name); 
  });
...
//     function largeRunners() {
//         if( runners[i].shirt_size === "L") {
//             largeShirts.push(runners[i].shirt_size)
//         }
//     }
// }

const largeRunners = runners.filter( function(currentValue){
    if( currentValue.shirt_size === "L") {
        largeShirts.push(currentValue.shirt_size)
    }
  });
  
  console.log(largeRunners);
