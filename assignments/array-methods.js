...
largeShirts = runners.filter(ele => ele.shirt_size === "L");
...
sum = runners.reduce(reducer, ticketPriceTotal);
    
console.log(sum); // not sure if what they want?

// ==== Challenge 5: Be Creative ====
// Now that you have used .forEach(), .map(), .filter(), and .reduce().  I want you to think of potential problems you could solve given the data set and the 5k fun run theme.  Try to create and then solve 3 unique problems using one or many of the array methods listed above.

// Problem 1
// Give an array of all runners with a small shirt size

let smallShirts = [];

smallShirts = runners.filter(ele => ele.shirt_size === "S");

console.log(smallShirts);

// Problem 2
// Give an array of all email addresses
...
// Problem 3
// Give an array with all last names lower case
let allLowerLast = [];

runners.map(function(ele) {
    allLowerLast.push(`${ele.last_name.toLowerCase()}`)
});

console.log(allLowerLast); 
