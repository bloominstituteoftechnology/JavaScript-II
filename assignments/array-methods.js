...
runners.forEach(function (list){
 fullName.push(list.first_name +' '+ list.last_name);
});
...
let allCaps = [];
   allCaps = runners.map (function name(list){;
    return (list.first_name).toUpperCase();
});
console.log(allCaps); 
...
let largeShirts = [];
largeShirts = runners.filter(function large (items){
