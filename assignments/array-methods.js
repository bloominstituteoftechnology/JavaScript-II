...
// forEach method is a higher ordered function(hof) , method is a function in an object, anon func
// var array1 = ['a', 'b', 'c'];
...
// var array1 = [1, 4, 9, 16];
// .map() used for converting
// pass a function to map
// const map1 = array1.map(x => x * 2);

// console.log(map1);
// expected output: Array [2, 8, 18, 32]
const runnersUppercase = runners.map(function(currentValue) {
  return currentValue.first_name.toUpperCase();
});
console.log(runnersUppercase);
// let allCaps = [];
// console.log(allCaps);

// ==== Challenge 3: Use .filter() ====
// The large shirts won't be available for the event due to an ordering issue.  Get a list of runners with large sized shirts so they can choose a different size. Return an array named largeShirts that contains information about the runners that have a shirt size of L and log the result
//  map is about converting, filerting is about ....filtering, returns a new array, doesn't manipulate original
//  if true keep the elemnt in the new array, if false don't keep it
//

const largeShirts = shirt_size.filter(function(currentValue) {
...
runners.reduce((acc, item, idx) => {
  acc = acc + item.donation;
  console.log("acc", acc, "donation:", item.donation, "idx:", idx);
  return acc;
}, 0);
