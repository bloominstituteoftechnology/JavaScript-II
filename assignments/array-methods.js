...
// const reducer = (donationTotal, donationAmount) => {
// return donationTotal + donationAmount;
// }

// console.log(runners.reduce(reducer));
...
// Problem 1
//Need to find last names and shirt size
let nameSize = 
let findSize = runners.forEach (function(i) {
    fullName.push(i.last_name + " " + i.shirt_size);
});
