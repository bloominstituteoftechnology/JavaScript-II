...
runners.map((firstNamesAllCaps)=>{
  console.log(`${firstNamesAllCaps.first_name.toUpperCase()}`)
  });
...
const ticketPriceTotal= runners.reduce((currentTotal, item) => { 
  return item.donation + currentTotal
}, 0)
console.log(ticketPriceTotal);
