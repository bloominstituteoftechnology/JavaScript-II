...
const allCapitalLetters = runners.map((item, index, array) => {
...
// const runnerLarge = runners.filter((index) => {
//   if (index.shirt_size === "L")
//   return largeShirts.push(.shirt_size);
// });
...
const whatever = runners.reduce((item, index, array) => {
