...
let allCaps = [];
let FirstCap = runners.map((element) => element.first_name.toUpperCase());
allCaps.push(FirstCap);
console.log(allCaps); 
...
let ticketPriceTotal = runners.reduce((total, taxable) =>{
    return total += taxable.donation;
}, 0);
