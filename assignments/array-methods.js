...
// Scroll to the bottom of the list to use some advanced array methods 
// to help the event director gather some information from the businesses.
...
ticketPriceTotal = runners.reduce((total, amount) => {
