...
let allCaps = [];
runners.map(function(n){
    console.log(n.first_name.toLocaleUpperCase());
    allCaps.push(runners);
})
console.log(allCaps); 
...
let largeShirts = [];
 largeShirts = runners.filter(function (n) {
    return n.shirt_size === "L";
  });
...
ticketPriceTotal = runners.reduce((total, ticket) => {
