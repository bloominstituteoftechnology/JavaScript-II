...
//# 1 - get email addy's for communications and updates 

let emailAddy = runners.map((runner) => runner.email);
console.log(emailAddy);

//# 2 sort runners by a particular company 

let lazzyBoyz = runners.filter((runner) => runner.company_name === "Lazzy");
console.log(lazzyBoyz);
