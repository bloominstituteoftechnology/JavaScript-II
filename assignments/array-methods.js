...
//I Need to loop through the array and find first and last names of the runners.
...
const firstNameAllCaps = runners.map(function (item) {
...
const runnersLargeSizeShirt = runners.filter(function (item) {
