...
const allCaps = runners.map(a => a.first_name.toUpperCase());
console.log(allCaps);

// ==== Challenge 3: Use .filter() ====
// The large shirts won't be available for the event due to an ordering issue.  Get a list of runners with large sized shirts so they can choose a different size. Return an array named largeShirts that contains information about the runners that have a shirt size of L and log the result
const largeShirts = runners.filter(a => {
  if (a.shirt_size === "L") {
    return a;
  }
});
...
const ticketPriceTotal = runners.reduce((a, b) => a + b.donation, 0);
...
// Problem 1
// === log how many of each shirt size ===
const counts = {};
...
// Problem 2
// === log how many unique companies there are ===
...
const uniques = runners.map(x => x.company_name);
console.log(uniques.unique());
console.log(uniques.unique().length);

// Problem 3
// === log the average amount of donations ===
const avgDonation = runners.reduce((acc, runner) => acc + runner.donation, 0) / runners.length;
