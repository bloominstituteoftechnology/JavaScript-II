...
// Problem 1
//Emails need to be combined into a mailing list in order to send the runners information before the event.
//Get a list of each runner's full name and email.
let mailingList = runners.map((runner) => {
    return `Name: ${runner['first_name']} ${runner['last_name']} Email: ${runner['email']}`
});
