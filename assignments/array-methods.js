...
const firstNameCaps = runners.map((name) => {
...
// const filterShirtSize = runners.filter((size) =>{
// 	let sizeFiltered = size.shirt_size === "L";
// 	return 	largeShirts.push(sizeFiltered);
//  });
// console.log(filterShirtSize);
