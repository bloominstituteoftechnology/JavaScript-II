...
// The donations need to be tallied up and reported for tax purposes. Add up all the donations into
// a ticketPriceTotal array and log the result
const priceArr = runners.map(runner => runner.donation);
let ticketPriceTotal = priceArr.reduce((total,accumulator) => {
