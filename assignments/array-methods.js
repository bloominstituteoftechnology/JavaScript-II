...
runners.forEach(company=> cNameeMail.push(`${company.email} ${company.company_name}`))

console.log(cNameeMail)


Problem 2
let mediumShirt =[]

mediumShirt = runners.filter(mShirts=>{
