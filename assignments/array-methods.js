...
//ES5
// let firstNamesCap = runners.map(function(element){
//   return element.first_name.toUpperCase();
// })

//ES6 refactored code
let firstNamesCap = runners.map((element) => element.first_name.toUpperCase());
console.log(firstNamesCap);
...
let ticketPriceTotal = runners.reduce(function(accumlator, element){
    accumlator += element.donation;
    return accumlator;
},0);
