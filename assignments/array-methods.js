...
let fullNames = []
// use forEach to loop over the runners array data to get -> ${first_name} and ${last_name}
// push the items we're looking for into fullNames array to output the results -> then console.log(fullNames)
...
//filter runners array for ONLY ${shirt_size === 'L}
let runnersLargeSizeShirt = runners.filter(items => items.shirt_size === 'L')
