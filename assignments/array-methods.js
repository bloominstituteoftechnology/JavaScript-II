...
let ticketPriceTotal = runners.reduce((totalDonation, currentValue) => {
...
// Problem 1
//The event director wants to know all the information of a runner who made the largest donation.
let largeDonation = runners.reduce((acc, currentValue) => {
...
let smallShirts = runners.filter(currentValue => {
...
let allEmails = runners.map(currentValue => {
