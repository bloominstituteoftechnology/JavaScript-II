...
let allCaps = [];
runners.map(item => allCaps.push(item.first_name.toLocaleUpperCase()));
console.log(allCaps);
...
// Problem 1
// get the item that donated more than 100 
let moreMoney = [];
moreMoney.push(runners.filter(runner => runner.donation > 100));
console.log(moreMoney)

// Problem 2
// Find  total years of experience of all of them
var pilots = [
  {
    id: 10,
    name: "Poe Dameron",
