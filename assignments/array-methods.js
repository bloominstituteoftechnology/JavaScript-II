...
let fullName = runners.forEach((fullNameCallback = ((item)=>{console.log(`${item.first_name} ${item.last_name}`)})))
...
let largeShirts = runners.filter(largeSorting = (item) => {
    let large = (item.shirt_size === "L"); return large});
...
let smallShirts = runners.filter((item)=>{
    let shirtCount = (item.shirt_size === 'S');
    return shirtCount;
  });
  
  let mediumShirts = runners.filter((item)=>{
    let shirtCount = (item.shirt_size === 'M');
    return shirtCount;
  });
  
  let largeShirts = runners.filter((item)=>{
    let shirtCount = (item.shirt_size === 'L');
    return shirtCount;
  });
  
  let extraLShirts = runners.filter((item)=>{
    let shirtCount = (item.shirt_size === 'XL');
    return shirtCount;
  });
  
  let twoXLShirts = runners.filter((item)=>{
    let shirtCount = (item.shirt_size === '2XL');
    return shirtCount;
  });
