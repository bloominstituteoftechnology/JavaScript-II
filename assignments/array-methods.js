...
// Problem 1
// Only get the people who donated 200 or more
let moreThan200 = runners.filter(x => x.donation > 200);
console.log(moreThan200);

// Problem 2
// Get a list of all the emails
let emailList = runners.map(x => x.email);
console.log(emailList)

// Problem 3
// Get a list of all the runners with a size S shirt
let smallShirts = runners.filter(x => x.shirt_size === "S");
