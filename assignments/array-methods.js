...
let ticketPriceTotal = runners.reduce(function(accumulatedTotal, person){
  return accumulatedTotal + person.donation;
}, 0);
console.log(`Total donations acquired: ${ticketPriceTotal}`);
