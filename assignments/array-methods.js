...
let sum = ticketPriceTotal.reduce((a,b) => a + b);
...
//The event director needs to know how many donations was 100 and above.

const arr100 = runners.filter(function(runner) {
...
//The event director needs to know total amount of donations 99 and less.

const arr99 = runners.filter(function(runner) {
	return runner["donation"] <= 99;
});

const arrDonation99 = [];
arr99.forEach(function(runner) {
	arrDonation99.push(runner.donation);
});

let sum99 = arrDonation99.reduce((a,b) => a + b);
console.log(sum99);