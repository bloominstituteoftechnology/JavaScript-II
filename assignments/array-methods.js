...
// Problem 1
const childrensNamesAge = [];
myChildren.forEach(myChildren => {
    return childrensNamesAge.push(`My daughters name is ${myChildren.name}, and she is ${myChildren.age}.`);
});
console.log(childrensNamesAge);
