...
// Problem 1
// Place the runners in alphabetical order using the runners last name
const runnerOrder = runners.map(runner => runner.last_name).sort();
console.log(runnerOrder);

// Problem 2
// List the top three company donations and company name
const topDonations = runners.sort((x, y) => y.donation - x.donation).slice(0, 3).map(company => {
  return {
