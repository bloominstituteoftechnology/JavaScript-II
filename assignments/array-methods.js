...
let ticketPriceTotal = runners.reduce(function(accumulator, currentTotal) {
    return accumulator += currentTotal["donation"];
  }, 0);
...
// Problem 1:
// long & complex calculations that accrue as data is added.

// Problem 2:
// quickly adding the same variable to all objects in the array (middle name, genders, etc.)

// Problem 3:
// changing all the donations to another currency with .map