...
ticketPriceTotal = runners.reduce((price, runner, index, runners ) =>{
...
// Problem 1 create a new club for runners who's last name starts with 'm'
let mRunners = runners.filter(runner => runner.last_name.charAt(0) === 'M');
console.log(mRunners);

// Problem 2 - a charity is matching donations given!
