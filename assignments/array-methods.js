...
runners.map(array => {
    allCaps.push(`${array.first_name.toUpperCase()} ${array.last_name.toUpperCase()}`)
});
...
largeShirts = runners.filter(running => {
    return running.shirt_size === "L"
});
...
// Problem 1
// Sort runners by company name.

function sortByCompany (){
    let runnersByCompany = [];

    runnersByCompany = runners.sort(function(a, b){
...
function sortSizes (){
    ...
    function filterThem (list, size) {
       let holder = list.filter(running => {
                return running.shirt_size === size
            });
       return holder; 
    }
    console.log(filterThem(runners, "XS"))
    console.log(filterThem(runners, "S"))
    console.log(filterThem(runners, "M"))
    console.log(filterThem(runners, "L"))
    console.log(filterThem(runners, "XL"))
    console.log(filterThem(runners, "2XL"))
