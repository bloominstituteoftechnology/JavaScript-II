...
// Problem 1
let emailAddress = [];
runners.forEach(runners => emailAddress.push(`${runners.email}`));
console.log(emailAddress);
// Problem 2
let largeDonations = [];
runners.filter(runners => {if (runners.donation >= 250) {largeDonations.push(runners)}});

console.log(largeDonations);

// Problem 3
let shirtLowerCase = [];
runners.map(runners => shirtLowerCase.push(runners.shirt_size.toLowerCase())),
