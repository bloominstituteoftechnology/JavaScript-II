...
fullName = runners.forEach((item) => {fullName.push(item.first_name + " " + item.last_name);
...
// Problem 1
// list of companies
let companies = runners.map(item => item.company_name);

// Problem 2
// people who donated 200 or more
generousPeople = runners.filter(item => item.donation >= 200);
