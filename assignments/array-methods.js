...
let largeShirts = [];
largeShirts = JSON.stringify( runners.filter( function( element )
{
...
let ticketPriceTotal = null;
ticketPriceTotal = runners.reduce( function( total, currentElement )
{   

    return total + currentElement.donation;
}, 0 );
