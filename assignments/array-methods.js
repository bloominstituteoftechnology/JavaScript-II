...
let ticketPriceTotal = runners.reduce((donation, total, index, runners) => {
...
// Problem 1
// The Skinix has undergone a merger, the Bounty corp. The new name is "Skinix + Bounty"; filter find Skinix participants & make the appropriate name changes.




let findSkinix = runners.filter((skinixCo) =>{
	return skinixCo.company_name === "Skinix"
});

findSkinix.company_name = "Skinix + Bounty"
console.log(findSkinix)
