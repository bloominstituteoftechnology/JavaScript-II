...
// Problem 1
// Runners that work at Skinix still need to fill out their biograpies for the fun run program. Find all the runners that work at Skinix then put their emails into an array so they can be sent a reminder email.
...
const entries = runners.filter(runner => runner['donation'] >= 150);
