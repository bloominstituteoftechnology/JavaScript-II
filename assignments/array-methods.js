...
// Problem 1
// Gets emails for participants
let emails = [];
runners.forEach((runner) => emails.push(`${runner.email}`));
console.log(emails);


// Problem 2
// Filters individuals for ones that donated over 100
let donations = runners.filter(runner => runner.donation >= 100);
