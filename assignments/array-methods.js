...
runners.forEach(function(elements){
  fullName.push(`${elements.first_name} ${elements.last_name}`);
});
...
// Problem 1
const alphabetically = runners.map( function(item) {
    return item.first_name;
  });
console.log(alphabetically.sort());

// Problem 2
const emailList = runners.map( function(item) {
    return item.email;
  });
console.log(emailList);

// Problem 3/
let companyOne = runners.filter((data) =>{
