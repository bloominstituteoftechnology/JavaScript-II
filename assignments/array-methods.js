...
// i) Access/Get both first and second names of each runner. 
// ii) Combine both names to one.
// iii) Put these names into a new Array.

runners.forEach(combineNames(first_name, lastName));

function combineNames(item, runners){
...
// iii) push them into an array called firstNamesAllCaps.
...
let ticketPriceTotal = runners.reduce(donations);
