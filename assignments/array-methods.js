...
// Project comments --------
// I used the solution for this one. I was writing my function
// incorrectly      and   didnt even know it. -MH
//--------------------------
console.log(allCaps);
...
//Project Comments --------
// I didn't need the solution for this one! ^_^ -MH
//-------------------------

// ==== Challenge 4: Use .reduce() ====
// The donations need to be tallied up and reported for tax purposes. Add up all the donations into a ticketPriceTotal array and log the result
let ticketPriceTotal = [];
ticketPriceTotal = runners.reduce((donationTotal, donationAmount) => {
  return donationTotal + donationAmount.donation;}, 0);
console.log(ticketPriceTotal);

//Project Comments --------
// This one required me to reference the solution because
// my function syntax was off. I need to practice them more -MH
//-------------------------
