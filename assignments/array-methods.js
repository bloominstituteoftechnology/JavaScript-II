...
console.log(fullNames.first_name + fullNames.last_name);
});
// ==== Challenge 2: Use .map() ====
...
const runnersLargeSizeShirt = (item) => {
  return item.shirt_size === "L"
}
largeShirts = runners.filter(runnersLargeSizeShirt)
...
// Problem 1
let lastNamesLowercase = [];
const lastNamesLowercase = runners.map(function(item){
  return item.last_name.toLowerCase();
});
console.log(lastNamesLowercase);

// Problem 2
let runnersMediumSizeShirt = [];
const runnersMediumSizeShirt = (item) => {
  return item.shirt_size === "M"
}
mediumShirts = runners.filter(runnersMediumSizeShirt)
console.log(mediumShirts);

// Problem 3
let idTotal = 0;
const idTotal = runners.reduce(function(accumulator, item){
