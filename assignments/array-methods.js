...
let ticketPriceTotal = runners.reduce(
  (ticketPriceTotal, current) => ticketPriceTotal + current.donation,
  0
);
...
// Problem 1
// filter out people who donated very little lets say 100
let donations = runners.filter(donations => donations.donation >= 100);
console.log(donations, "problem 1");
