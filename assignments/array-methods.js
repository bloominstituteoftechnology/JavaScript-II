...
let fullName = runners.forEach(function(item, index, array) {
...
let allCaps = runners.map((item, index, array) => { 
...
let LargeShirts = [];
const NewSize = runners.filter(LargeShirts => LargeShirts.length >= "L");
console.log(NewSize);
