...
const power = runners.map(function(first){
...
const wearsLarge = runners.filter(size => size.shirt_size === "L");

largeShirts.push(wearsLarge)
...
const forTaxes = runners.reduce((total, donations) => total + donations.donation, 0);

ticketPriceTotal.push(forTaxes);
