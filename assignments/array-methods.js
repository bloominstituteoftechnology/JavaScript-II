...
let allCaps = [];
allCaps = runners.map((fn) => fn.first_name.toUpperCase());
console.log(allCaps);
...
let total = ticketPriceTotal.reduce((accumulator, currentValue) => accumulator + currentValue);
