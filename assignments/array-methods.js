...
let fullNames = runners.forEach(function(element) {
...
let runnersLargeSizeShirt = runners.filter (function(element) {
...
let ticketPriceTotal = runners.reduce(function (accumulator, element){
