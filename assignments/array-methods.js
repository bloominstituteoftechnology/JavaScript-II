...
let fullNames = [];
runners.forEach(/* TODO: Add solution here */);
...
let allCaps = runners.map(/* TODO: Add solution here */);
console.log(allCaps); 

// ==== Challenge 3: Use .filter() ====
/* The large shirts won't be available for the event due to an ordering issue. Get a list of runners
   with large sized shirts so they can choose a different size. Return an array named largeShirts
   that contains information about the runners that have a shirt size of L and log the result. */

let largeShirts = runners.filter(/* TODO: Add solution here */);
...
let ticketPriceTotal = runners.reduce(/* TODO: Add solution here */);
