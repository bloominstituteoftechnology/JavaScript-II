...
let largeShirts = runners.filter(runner => runner.shirt_size === 'L').map(runner => runner.first_name);
...
// We can filter people who donated more than $100 to give them a special thank you certificate

// Problem 2

// We can loop through each runner's info to get their email and send them information on future events

// Problem 3

// We can go through and collect all of the company names without duplicates and use that for marketing