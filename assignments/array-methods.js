...
let allCaps = runners.map(function(item){
    ...
    console.log(runners.toUpperCase());
...
// let ticketPriceTotal = runners.reduce(function(item){
...
// Problem 1
    ...
    //Runners who donated over $100 | .filter()

    let highDonors = runners.filter(function(item){
