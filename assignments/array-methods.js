...
let fullName = [];
let runnerNames = runners.forEach(fucntion(e) {
  fullName.push(runners[e.first_name + " " + e.last_name)
})
...
let largeShirts = runners.filter(function(shirt) {
   return shirt.shirt_size === "L";
});
console.log(largeShirts);
// ==== Challenge 4: Use .reduce() ====
// The donations need to be tallied up and reported for tax purposes. Add up all the donations into a ticketPriceTotal array and log the result
let ticketPriceTotal = runners.reduce(function(acc1, acc2) {
