...
let fullName = [];
runners.forEach(function (players) {
    let player = `${players.first_name} ${players.last_name}`;
...
let ticketPriceTotal = runners.reduce(function (sum, money) {
    return sum + money.donation;
}, 0)
