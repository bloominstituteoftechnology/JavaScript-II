...
runners.forEach(cb => {
    ...
    fullNames.push(cb.first_name + " " + cb.last_name)
...
runners.map(cb => {
  ...
  firstNamesAllCaps.push(cb.first_name.toUpperCase())
...
ticketPriceAverage=runners.reduce(function (acc, obj) { return acc + obj.donation; }, 0);

console.log(ticketPriceAverage/runners.length);
// Problem 2
