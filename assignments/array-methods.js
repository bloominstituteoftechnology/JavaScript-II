...
// Problem 2
// Average donation
let ticketPriceAverage = runners.reduce((total, runner) => {
    return total += runner.donation;
}, 0) / runners.length;
console.log(ticketPriceAverage);

// Problem 3
// Average large shirts
let avgLgShirt = largeShirts.reduce((total, runner) => {
    return total += 1;
}, 0) / runners.length;
console.log(avgLgShirt);