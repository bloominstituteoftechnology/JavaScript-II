...
// Problem 1: Use .filter() to see if first_name starts with 'M' then create an array of just those first names.  They ran out of M's for the shirts I guess. :P
let firstNames = [];

runners.filter(runner => {if (runner.first_name.startsWith('M')){firstNames.push(runner.first_name)}})
