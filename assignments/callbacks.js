...
function removeDuplicates(array, cb) {
  ...
  const noDuplicates = array.filter((element, currentIndex, filteredArray) => filteredArray.indexOf(element) >= currentIndex);
  return cb(noDuplicates);
}

const testArray1 = ['sarah', 'jeff', 'gregory', 'yawen', 'mandy sue'];
const testArray2 = ['sarah', 'sarah', 'sarah', 'jeff', 'jimothy'];
removeDuplicates(testArray1, (noDups) => console.log(`Never had any dups!\n${noDups}`));
removeDuplicates(testArray2, (noDups) => console.log(`Had some dups, but now they're gone.\n${noDups}`));