...
console.log(getLength(items, displayLength))

//build a function to pass into cb to use the length
function displayLength(name) {
    return `The length of array is ${name}`
}
displayLength('Todd')
...
function lastItemArray(lastItemValue) {
    return lastItemValue[lastItemValue.length - 1]
}
console.log(last(items, lastItemArray))
